            ...
            <div class="col s12 m12 l12">
                <div class="card">
                    ...
                    <?php $sql = "SELECT a.sell_id as sell_id,a.sell_name as sell_name,a.sell_amount as sell_amount,a.sell_price as sell_price, a.sell_date as sell_date ,a.sell_who as sell_who, b.echo_name as echo_name FROM sell_phone as a INNER JOIN status_phone as b ON b.echo_id = a.echo_id;";
                        ...
                        if ($query->rowCount() > 0) {
                            foreach ($results as $result) {               ?>
                            <?php echo htmlentities($result->sell_name); ?>
                            <?php echo htmlentities($result->sell_amount); ?>
                            <?php echo htmlentities($result->sell_price);  ?>
                            <?php echo htmlentities($result->echo_name); ?>
                            <?php echo htmlentities($result->sell_date); ?>
                            <?php echo htmlentities($result->sell_who); ?>
                            <?php echo "<br>"?>
                        <?php $cnt++;
                            }
                        } ?>
