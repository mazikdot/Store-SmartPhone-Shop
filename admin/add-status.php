...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['add'])) {
        ...
        $sql = "INSERT INTO phone_status(status_name) VALUES(:status_name)";
                                                ...
                                                <div class="col m6">
                                                    <div class="row">
                                                        <div class="input-field col  s12">
                                                            <label for="status_name">สถานะที่ต้องการเพิ่ม</font></label>
                                                            <input name="status_name" id="status_name" onBlur="checkAvailabilityEmpid()" type="text" autocomplete="off" required>
